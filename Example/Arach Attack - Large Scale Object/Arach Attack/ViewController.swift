...
//        let pumpkinScene = SCNScene(named: "Media.scnassets/Hellknight.scn")
//        let pumpkinNode = (pumpkinScene?.rootNode.childNode(withName: "body", recursively: false))!
        
        let pumpkinScene = SCNScene(named: "Media.scnassets/spider.scn")
        let pumpkinNode = (pumpkinScene?.rootNode.childNode(withName: "Spider", recursively: false))!
        
        
        pumpkinNode.position = SCNVector3(x,y+20,z-100)
        pumpkinNode.eulerAngles = eulerangles
        //pumpkinNode.scale = SCNVector3(0.001,0.001,001)
...
//
    ...
    func towardsPOVMovement(node: SCNNode) {
        ...
        let hover = SCNAction.move(to: location1, duration: 7.5)
